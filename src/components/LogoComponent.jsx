...
function LogoComponent() {
  ...
  return (
    <div className="flex items-center gap-2 mb-5 pl-[28px] pt-[20px]">
      ...
      <div
        className={`xs:flex flex-col text-nowrap transition-all duration-500 ${
          isCollapsed ? "opacity-0 pointer-events-none w-0" : "opacity-100 hidden"
        }`}
      >
        <span className="text-xl tracking-wide">ប្រព័ន្ធចតរថយន្តឆ្លាតវៃ</span>
        <span className="text-sm text-opacity-70 text-black tracking-wide">
